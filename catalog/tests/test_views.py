...
class AuthorCreateViewTest(TestCase):
    @classmethod
    def setUpOneAuthor(cls):
        # Create one author
        test_author_first_name = Author.objects.create(first_name='John')
        test_author_last_name = Author.objects.create(last_name='Smith')
        test_date_of_birth = Author.objects.create(date_of_birth='09-09-2009')
        test_date_of_death = Author.objects.create(date_of_death='09-10-2009')
        test_Author = Author.objects.create(
            first_name='Niels',
            last_name='Bohr',
            date_of_birth='01-01-1901',
            date_of_death='01-01-2001',
            )
#
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_language = Language.objects.create(type='English')  #TODO
